...
In order to support loading of multiple wallets in trip-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is trip.cpp.
...
Changes to trip.cpp
----------------------
trip.cpp is the entry point into trip-qt, and as such, will require some minor modifications to provide hooks for
