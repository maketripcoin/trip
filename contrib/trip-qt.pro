...
RESOURCES += src/qt/trip.qrc src/qt/trip_locale.qrc

TRANSLATIONS += src/qt/locale/trip_bg.ts \
                src/qt/locale/trip_de.ts \
                src/qt/locale/trip_en.ts \
                src/qt/locale/trip_es.ts \
                src/qt/locale/trip_fi.ts \
                src/qt/locale/trip_fr.ts \
                src/qt/locale/trip_it.ts \
                src/qt/locale/trip_ja.ts \
                src/qt/locale/trip_pl.ts \
                src/qt/locale/trip_pt.ts \
                src/qt/locale/trip_ru.ts \
                src/qt/locale/trip_sk.ts \
                src/qt/locale/trip_sv.ts \
                src/qt/locale/trip_vi.ts \
                src/qt/locale/trip_zh_CN.ts \
                src/qt/locale/trip_zh_TW.ts
