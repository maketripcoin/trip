...
/** 
    ...
    ****Note - for Trip we added fCoinStake to the 2nd bit. Keep in mind when reading the following and adjust as needed.
...
public:
    ...
    /** 
     * Amount of trip coming in to a transaction
