                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Trip Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Trip address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and trip: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zTRIP"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Trip Core"), this);
    aboutAction->setStatusTip(tr("Show information about Trip Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Trip"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Trip addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Trip addresses"));
    ...
    openAction->setStatusTip(tr("Open a Trip: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Trip Core help message to get a list with possible Trip command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Trip Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Trip network", "", count));
}
...
{
    QString strTitle = tr("Trip Core"); // default title
