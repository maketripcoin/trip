                                                    ...
                                                    transactionView(0)
{
    ...
    typeWidget->addItem(tr("Received Trip from zTrip"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zTrip"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zTrip));
