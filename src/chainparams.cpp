...
public:
    CMainParams()
    {
        ...
        nDefaultPort = 40500;
        bnProofOfWorkLimit = ~uint256(0) >> 20; // Trip starting difficulty is 1 / 2^12
        ...
        nMinerThreads = 0;
        nTargetTimespan = 1 * 60; // Trip: 1 day
        nTargetSpacing = 1 * 90;  // Trip: 1 minute
        nMaturity = 10;
         ...
         *   vMerkleTree: e0028e
         */
        const char* pszTimestamp = "World leaders laugh as Trump boasts of accomplishments during UN speech";
        CMutableTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CScriptNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 0 * COIN;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("04cf99f55576e6d59ecb21ef224172687dce2e93d1b637fa9e56a3c6ba925efa527d0f414b0b8a9311bc05ef413fcad88f7f8151d5059f6537813f049cf250e4d8") << OP_CHECKSIG;
        genesis.vtx.push_back(txNew);
        genesis.hashPrevBlock = 0;
        genesis.hashMerkleRoot = genesis.BuildMerkleTree();
        genesis.nVersion = 1;
        genesis.nTime = 1537917411;
        genesis.nBits = 0x1e0ffff0;
        genesis.nNonce = 20558303;
	...
	vSeeds.push_back(CDNSSeedData("dns1.tripcoin.live", "dns1.tripcoin.live"));         // Single node address
        vSeeds.push_back(CDNSSeedData("dns2.tripcoin.live", "dns2.tripcoin.live"));       // Single node address
        vSeeds.push_back(CDNSSeedData("dns3.tripcoin.live", "dns3.tripcoin.live"));       // Single node address
	vSeeds.push_back(CDNSSeedData("dns4.tripcoin.live", "dns4.tripcoin.live"));
	vSeeds.push_back(CDNSSeedData("dns5.tripcoin.live", "dns5.tripcoin.live")); 		
        ...
        strSporkKey = "0445c8311b7527cbd3923707c5a265038ed9c60d456c623ee4e417d68b3024d7974b1eee670c7ab8953bfdb38bb7cec453c0246c79264a553d537baead805fcc1d";
        strObfuscationPoolDummyAddress = "XQiDqZzueA1A7xrLDLM6b482JXYshhLM8c";
        nStartMasternodePayments = 1535605200; //
...
public:
    CTestNetParams()
    {
        ...
        nMinerThreads = 0;
        nTargetTimespan = 1 * 60; // Trip: 1 day
        nTargetSpacing = 1 * 60;  // Trip: 1 minute
        nLastPOWBlock = 200;
        nMaturity = 15;
        ...
        genesis.nTime = 1537917765;
        genesis.nNonce = 20754463;

	    hashGenesisBlock = genesis.GetHash();
        assert(hashGenesisBlock == uint256("0x000005345a624b4f3fe2ad0dc0f2853322b32ebc9913d39bc8e9e209f79f603e"));

        vFixedSeeds.clear();
        vSeeds.clear();
        vSeeds.push_back(CDNSSeedData("testnet.tripcoin.live", "testnet.tripcoin.live"));         // Single node address
        vSeeds.push_back(CDNSSeedData("testnet1.tripcoin.live", "testnet1.tripcoin.live"));       // Single node address
        vSeeds.push_back(CDNSSeedData("testnet.tripcoin.live", "testnet.tripcoin.live"));       // Single node address
        ...
        // Testnet trip BIP44 coin type is '1' (All coin's testnet default)
