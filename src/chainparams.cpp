...
static const Checkpoints::CCheckpointData data = {
    &mapCheckpoints,
    1537487947, // * UNIX timestamp of last checkpoint block
    50667,    // * total number of transactions between genesis and last checkpoint
...
public:
    CMainParams()
    {
         ...
         *   vMerkleTree: e0028e
         */
        const char* pszTimestamp = "Weary and scared: Venezuelans flee as economic crisis deepens .";
        ...
        genesis.nVersion = 1;
        genesis.nTime = 1535576284;
        genesis.nBits = 0x1e0ffff0;
        genesis.nNonce = 20677422;
