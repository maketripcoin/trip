...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Trip features */
        {"trip", "masternode", &masternode, true, true, false},
        {"trip", "listmasternodes", &listmasternodes, true, true, false},
        {"trip", "getmasternodecount", &getmasternodecount, true, true, false},
        {"trip", "masternodeconnect", &masternodeconnect, true, true, false},
        {"trip", "masternodecurrent", &masternodecurrent, true, true, false},
        {"trip", "masternodedebug", &masternodedebug, true, true, false},
        {"trip", "startmasternode", &startmasternode, true, true, false},
        {"trip", "createmasternodekey", &createmasternodekey, true, true, false},
        {"trip", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"trip", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"trip", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"trip", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"trip", "getmasternodescores", &getmasternodescores, true, true, false},
        {"trip", "mnbudget", &mnbudget, true, true, false},
        {"trip", "preparebudget", &preparebudget, true, true, false},
        {"trip", "submitbudget", &submitbudget, true, true, false},
        {"trip", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"trip", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"trip", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"trip", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"trip", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"trip", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"trip", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"trip", "checkbudgets", &checkbudgets, true, true, false},
        {"trip", "mnsync", &mnsync, true, true, false},
        {"trip", "spork", &spork, true, true, false},
        {"trip", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"trip", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use tripd, or the -server option to trip-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> trip-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:41000/\n";
}
