Contributing to Trip Core
============================

The Trip Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Trip Core project, and is not to be
confused with overall Trip Network Protocol consensus changes.

Whether a pull request is merged into Trip Core rests with the project merge
...
Patches that change Trip consensus rules are considerably more involved than
...
Where a patch set proposes to change the Trip consensus, it must have been
...
The project leader is the release manager for each Trip Core release.
